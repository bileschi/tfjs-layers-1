...
import {OneHot, OneHotLayerConfig, UnitVariance, UnitVarianceConfig, VocabLayer, VocabLayerConfig, ZeroMean, ZeroMeanConfig} from './preprocess-layers/preprocess_core';
 ...
 *   subheading: 'Preprocessing',
 *   namespace: 'layers',
 *   useDocsFrom: 'UnitVariance',
 *   configParamIndices: [0]
 * }
 */
export function unitVariance(config: UnitVarianceConfig): Layer {
  return new UnitVariance(config);
}
